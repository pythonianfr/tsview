                    ...
                    case atom of
                        Symbol opname ->
                            case opname of
                                ...
                                "by.at-path" ->
                                    case args of
                                        [x] -> onestring "at-path" args  ByAtPath1      -- no optional param
                                        [x,y] -> strandbool "at-path" [x,y] ByAtPath2   -- positional param
                                        [x,_,y] -> strandbool "at-path" [x,y] ByAtPath2 -- keyword para
                                        _ -> Err "bad operator "
                                "by.without-path" ->
                                    Ok ByWithoutPath
                                "by.cache" ->
